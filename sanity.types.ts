...
export type AllSanitySchemaTypes = LessonCompletion | Enrollment | BlockContent | Lesson | Module | Course | Category | Instructor | Student | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
